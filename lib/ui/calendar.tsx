  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-gradient-to-r from-[#E01E1F] to-[#FEA519] text-white hover:bg-gradient-to-r hover:from-[#E01E1F] hover:to-[#FEA519] hover:text-white focus:bg-gradient-to-r focus:from-[#E01E1F] focus:to-[#FEA519] focus:text-white",
